  ...
  Widget _buildProgress() {
    return Row(
      children: <Widget>[
        ...
        SizedBox(width: 12),
        Flexible(child: NeumorphicProgress(height: 15, percent: 0.55)),
        SizedBox(width: 12),
      ],
    );
  }
  ...
  Widget _buildIndeterminateProgress() {
    return Row(
      children: <Widget>[
        Text("Progress", style: TextStyle(color: _textColor())),
        SizedBox(width: 12),
        Flexible(child: NeumorphicProgressIndeterminate(height: 10)),
        SizedBox(width: 12),
      ],
    );
  }
    ...
    return Row(
      children: <Widget>[
        ...
        NeumorphicSwitch(
          ...
          style: NeumorphicSwitchStyle(thumbShape: NeumorphicShape.convex),
          onChanged: (value) {
            setState(() {
